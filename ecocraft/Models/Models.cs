...
public class DynamicValue
{
        ...
        foreach (var modifier in Modifiers)
        {
            switch (modifier.DynamicType)
            {
                ...
                case "Talent":
                    ...
                    break;
                case "Skill":
                    multiplier *= modifier.Skill?.CurrentUserSkill is not null ? modifier.Skill.LaborReducePercent[modifier.Skill.CurrentUserSkill.Level] : 1m;
                    break;
                /*case "Layer":
    ...
    public string GetMultiplierTooltip(LocalizationService localizationService)
    {
        List<string> tooltip = [];
        ...
        return beginning + string.Join(", ", tooltip);
    }
}
