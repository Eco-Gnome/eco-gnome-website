	...
	: IGenericUserDbService<UserCraftingTable>
{
	...
	public UserCraftingTable Add(UserCraftingTable shoppingListCraftingTable)
	{
		context.UserCraftingTables.Add(shoppingListCraftingTable);
		shoppingListCraftingTable.CraftingTable.CurrentUserCraftingTable = shoppingListCraftingTable;
